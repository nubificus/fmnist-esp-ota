...
TFLITE_LIB_DIR="${SCRIPT_DIR}/../components/<tfmicro>/"
cd "${TFLITE_LIB_DIR}"
...
python3 -m venv "${SCRIPT_DIR}"/temp_env

# Activate the virtual environment
source "${SCRIPT_DIR}"/temp_env/bin/activate
...
rm -rf third_party
# rm -rf signal
mv "${TEMP_DIR}/tflm-out/tensorflow/lite" tensorflow/lite
